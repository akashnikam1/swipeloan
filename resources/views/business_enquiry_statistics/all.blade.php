                ...
                <div class="col-sm-4">
                    <div class="card card-full" style="background-color: #4DA1A1">
                        <div class="card-inner">
                            ...
                            <h5 id="total_clicks" class="fs-1 text-white">{{ $totalClickCount }}</h5>
                ...
                <div class="col-sm-4">
                    <div class="card card-full" style="background-color: #7A65EA">
                        <div class="card-inner">
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                ...
                                <div class="card-tools">
                                    <ul class="card-tools-nav">
                                        <li class="">
                                            <a href="{{ url('users/all') }}" class="link link-white">
                            ...
                            <h5 id="total_users" class="fs-1 text-white">{{ $totalUserCount }}</h5>
    ...
    <script type="text/javascript">
        ...
        function datatable1() {
            ...
            NioApp.DataTable('#myTable', {
                ...
                ajax: "{{ url('business_enquiry_statistics/all') }}?from_date=" + from_date + "&to_date=" + to_date,
                "order": [
                    // [0, "desc"]
                ],
                responsive: !0,
                ...
                "columns": [{
                        ...
                        "render": function(data, type, row) {
                            return data ? '<a href="{{ url('users/user_details') }}/' + row.id +
                                '"><span>' + data + '</span></a>' :
                                '<a href="{{ url('users/user_details') }}/' + row.id +
                                '"><span>NA</span></a>';
                        }
                    },
                    {
