        ...
        <div class="nk-block-head nk-block-head-sm">
            ...
            <div class="nk-block-between">
                <div class="nk-block-head-content">
                    <h3 class="nk-block-title page-title">Partner</h3>
                        ...
                        <div class="toggle-expand-content" data-content="pageMenu">
                            <ul class="nk-block-tools g-3">
                                <li class="nk-block-tools-opt d-none d-sm-block">
                                    <a href="{{ url('partners/add') }}" class="btn btn-primary"><em
                                            class="icon ni ni-plus"></em><span>Add Partner</span></a>
                                </li>
                ...
                "columns": [
                    {
                        ...
                        "mRender": function(data, type, row) {
                             if (row.partner_image) {
                                var imageUrl = '{{ asset('storage/app/public/') }}' + '/' + row.partner_image;
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            ...
                            url: "{{ url('partners/change-status') }}",
                            type: "POST",
                            data: {
                                'id': id,
                                'status': status
