            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                <tr>
                    <td bgcolor="#ffffff" align="left" style="padding: 20px 30px 20px 30px; color: #666666; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 25px;">
                        ...
                        <p>
                            Dear <?php echo e($data['first_name'] ?? ''); ?><?php echo e(isset($data['last_name']) ? ' ' . $data['last_name'] : ''); ?>,
                        </p>                        
                            ...
                            <tr>
                                <td bgcolor="#ffffff" align="center" style="padding: 20px 30px 40px 30px;">
                                    <table border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <span id="otp" style="display: none"><?php echo e($data['otp']); ?></span>
                                            <td align="center" style="border-radius: 3px;" bgcolor="#1AA0A0">
                                                <a href="javascript:void(0);" id="otpLink" style="font-size: 20px; font-family: Helvetica, Arial, sans-serif; 
                                                    color: #ffffff; text-decoration: none; color: #ffffff; text-decoration: none; 
                                                        padding: 15px 25px; border-radius: 2px; border: 1px solid #1AA0A0; display: inline-block;" onclick="copyOTP()"><?php echo e($data['otp']); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.emailApp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/swipeloan/resources/views/emails/email_otp.blade.php ENDPATH**/ ?>