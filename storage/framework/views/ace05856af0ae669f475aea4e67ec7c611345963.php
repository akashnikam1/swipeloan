    ...
    <script type="text/javascript">
        ...
        function datatable1() {
            ...
            NioApp.DataTable('#myTable', {
                ...
                ajax: "<?php echo e(url('payments/all')); ?>?from_date=" + from_date + "&to_date=" + to_date + "&user_id=" + user_id,
                "order": [
                    // [0, "desc"]
                ],
                responsive: !0,
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/swipeloan/resources/views/payments/all.blade.php ENDPATH**/ ?>